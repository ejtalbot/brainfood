...
#TODO - set env vars and how to derive 
...
def tmain(*args, **kwargs):
    ...
    # read in device_id and device_model_id from device_config
    try:
    ...
    @device_handler.command('grocery.actions.AddGroceryItem')
    def add_grocery_item(number, grocery_item):
        logging.info(f'Adding {number} {grocery_item}')
